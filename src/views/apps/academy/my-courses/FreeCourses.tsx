            ...
            <div className='border rounded bs-full'>
              <div className='mli-2 mbs-2 overflow-hidden rounded'>
                <ReactPlayer
                  ...
                  light={
                    <img src='/images/apps/academy/7.png' alt='Thumbnail' className='is-full h-50! object-cover' />
                  }
                  playIcon={
            ...
            <div className='border rounded bs-full'>
              <div className='mli-2 mbs-2 overflow-hidden rounded'>
                <ReactPlayer
                  ...
                  className='bg-black is-full!'
                  light={
                    <img src='/images/apps/academy/8.png' alt='Thumbnail' className='is-full h-50! object-cover' />
                  }
                  playIcon={
                    <CustomIconButton variant='contained' color='error' className='absolute rounded-full'>
                      <i className='tabler-player-play' />

...
const FullscreenModal = ({ item, open, loading, onClose }) => {
    ...
    return (
        <div 
        className="fixed inset-0 bg-opacity-70 flex justify-center items-center z-9999"
        >
        <div className="bg-white text-black w-[50%] h-fit rounded-xl p-5 overflow-auto relative">
            ...
            <div className="grid grid-cols-4">
                ...
                <div className="flex flex-col ">
                    ...
                    <div className="text-2xl "> {item.c_station} </div>
                </div>
            </div>
